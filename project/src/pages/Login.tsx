...
import { Wand2, Github, Mail } from 'lucide-react';
      ...
      <div className="max-w-md w-full relative">
        ...
        <div className="bg-gray-900/80 backdrop-blur-xl rounded-2xl shadow-2xl p-8 relative border border-gray-800">
          ...
          <div className="space-y-4 mb-6">
            ...
            <button  onClick={()=>{window.location.href = 'http://localhost:3000/auth/github';}} className="w-full flex items-center justify-center gap-3 bg-gray-800 text-white py-2 px-4 rounded-lg hover:bg-gray-700 transition duration-300 transform hover:scale-105">
